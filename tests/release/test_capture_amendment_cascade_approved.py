"""live: capture the amendment-cascade-approved fixture against a fresh
...
cascades (via `referencing_phases`) into phase 3's metric coverage -- an
amendment unit spanning multiple phases, approved as one unit. See
