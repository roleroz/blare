"""live: capture the amendment-cascade-rejected fixture against the real
...
asks for a failure-mode rename that cascades into phase 3's metric coverage
-- an amendment unit spanning multiple phases, rejected as one unit (every
joined phase's repairs restored together). Tagged `live`, `exclusive` -- see
